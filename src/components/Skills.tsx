...
export function Skills() {
    const educations = [
        {
        name: "Fundamentos Azure (AZ-900) | Escola da Nuvem",
        },
       {
        name: "Residência de Software. Presencial - DESENVOLVIMENTO DE SOFTWARE FULLSTACK (WEB E MOBILE) | SERRATEC",
       },
       {
        name: "Curso Superior de Tecnologia em Análise e Desenvolvimento de Sistemas | Universidade Estácio de Sá", 
       },
      ]
