...
export function Services() {
    const services = [
        ...
        {
          title: "Mobile",
          description: "Desenvolvimento de aplicativos com React-Native.",
    ...
    return (
        <section className="container mx-auto my-12 max-w-4xl p-4">
            <div className="relative p-4 text-center">
                ...
                <h2 className="relative mb-2 font-bold text-blue-900">
                ...
                {/*<div className="absolute right-1/2 top-8 z-0 h-10 w-10 rounded-lg bg-blue-100/40" />*/}
            </div>
